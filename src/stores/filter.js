    ...
    const classData = ref([
        {
            ...
            abbreviation: '战士',
            talents: [
                {talentId: 1, icon: '/talents/warrior_fury.webp', name: '狂怒'},
                // {talentId: 2, icon: '/talents/warrior_fury.webp', name: '狂怒（副）'},
                {talentId: 3, icon: '/talents/warrior_arm.webp', name: '武器'},
                // {talentId: 4, icon: '/talents/warrior_arm.webp', name: '武器（副）'},
                {talentId: 5, icon: '/talents/warrior_protection.webp', name: '防御'},
        ...
        },
        {
            ...
            abbreviation: '猎人',
            talents: [
                {talentId: 8, icon: '/talents/hunter_marksmanship.webp', name: '射击'},
                // {talentId: 9, icon: '/talents/hunter_marksmanship.webp', name: '射击（副）'},
                {talentId: 10, icon: '/talents/hunter_beast.webp', name: '野兽'},
                // {talentId: 11, icon: '/talents/hunter_beast.webp', name: '野兽（副）'},
                {talentId: 12, icon: '/talents/hunter_survival.webp', name: '生存'},
        ...
        },
        {
            ...
            abbreviation: '萨满',
            talents: [
                {talentId: 15, icon: '/talents/shaman_enhancement.webp', name: '增强'},
                // {talentId: 16, icon: '/talents/shaman_enhancement.webp', name: '增强（副）'},
                {talentId: 17, icon: '/talents/shaman_elemental.webp', name: '元素'},
        ...
        },
        {
            ...
            abbreviation: 'RL',
            talents: [
                {talentId: 21, icon: '/talents/rogue_assassination.webp', name: '奇袭'},
                // {talentId: 22, icon: '/talents/rogue_assassination.webp', name: '奇袭（副）'},
                {talentId: 23, icon: '/talents/rogue_subtlety.webp', name: '敏锐'},
                // {talentId: 24, icon: '/talents/rogue_subtlety.webp', name: '敏锐（副）'},
                {talentId: 25, icon: '/talents/rogue_outlaw.webp', name: '狂徒'},
        ...
        },
        {
            ...
            abbreviation: '法师',
            talents: [
                {talentId: 28, icon: '/talents/mage_fire.webp', name: '火焰'},
                // {talentId: 29, icon: '/talents/mage_fire.webp', name: '火焰（副）'},
                {talentId: 30, icon: '/talents/mage_frost.webp', name: '冰霜'},
                // {talentId: 31, icon: '/talents/mage_frost.webp', name: '冰霜（副）'},
                {talentId: 32, icon: '/talents/mage_arcane.webp', name: '奥术'},
        ...
        },
        {
            ...
            abbreviation: '小德',
            talents: [
                {talentId: 35, icon: '/talents/druid_feral.webp', name: '野性'},
                // {talentId: 36, icon: '/talents/druid_feral.webp', name: '野性（副）'},
                {talentId: 37, icon: '/talents/druid_balance.webp', name: '平衡'},
                // {talentId: 38, icon: '/talents/druid_balance.webp', name: '平衡（副）'},
                {talentId: 39, icon: '/talents/druid_guardian.webp', name: '守护'},
        ...
        },
        {
            ...
            abbreviation: '骑士',
            talents: [
                {talentId: 43, icon: '/talents/paladin_retribution.webp', name: '惩戒'},
                // {talentId: 44, icon: '/talents/paladin_retribution.webp', name: '惩戒（副）'},
                {talentId: 45, icon: '/talents/paladin_protection.webp', name: '防护'},
        ...
        },
        {
            ...
            abbreviation: '术士',
            talents: [
                {talentId: 49, icon: '/talents/warlock_affliction.webp', name: '痛苦'},
                // {talentId: 50, icon: '/talents/warlock_affliction.webp', name: '痛苦（副）'},
                {talentId: 51, icon: '/talents/warlock_demonology.webp', name: '恶魔'},
                // {talentId: 52, icon: '/talents/warlock_demonology.webp', name: '恶魔（副）'},
                {talentId: 53, icon: '/talents/warlock_destruction.webp', name: '毁灭'},
        ...
        },
        {
            ...
            abbreviation: '牧师',
            talents: [
                {talentId: 56, icon: '/talents/priest_shadow.webp', name: '暗影'},
                // {talentId: 57, icon: '/talents/priest_shadow.webp', name: '暗影（副）'},
                {talentId: 58, icon: '/talents/priest_holy.webp', name: '神伤'},
                // {talentId: 59, icon: '/talents/priest_holy.webp', name: '神伤（副）'},
                {talentId: 60, icon: '/talents/priest_holy.webp', name: '神圣（疗）'},
                {talentId: 61, icon: '/talents/priest_discipline.webp', name: '戒律'},
        ...
        },
        {
            ...
            abbreviation: 'DK',
            talents: [
                {talentId: 64, icon: '/talents/dk_frost.webp', name: '冰霜'},
                // {talentId: 65, icon: '/talents/dk_frost.webp', name: '冰霜（副）'},
                {talentId: 66, icon: '/talents/dk_unholy.webp', name: '邪恶'},
                // {talentId: 67, icon: '/talents/dk_unholy.webp', name: '邪恶（副）'},
                {talentId: 68, icon: '/talents/dk_blood.webp', name: '鲜血'},
        ...
        },
        {
            ...
            abbreviation: '武僧',
            talents: [
                {talentId: 71, icon: '/talents/monk_windwalker.webp', name: '踏风'},
                // {talentId: 72, icon: '/talents/monk_windwalker.webp', name: '踏风（副）'},
                {talentId: 73, icon: '/talents/monk_brewmaster.webp', name: '酒仙'},
                // {talentId: 74, icon: '/talents/monk_brewmaster.webp', name: '酒仙（副）'},
                {talentId: 75, icon: '/talents/monk_mistweaver.webp', name: '织雾'},
        ...
        },
        {
            ...
            abbreviation: 'DH',
            talents: [
                {talentId: 78, icon: '/talents/dh_havoc.webp', name: '浩劫'},
        ...
        },
        {
            ...
            abbreviation: '龙人',
            talents: [
                {talentId: 82, icon: '/talents/evoker_devastation.webp', name: '湮灭'},
