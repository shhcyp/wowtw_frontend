...
watch(usernameResponseData, () => {
    if (props.name === 'username') {
        ...
        switchGreen.value = usernameResponseData.value.code === 1 ? true : false
    }
}, {
    deep: true
})
...
watch(verificationCodeResponseData, () => {
    if (props.name === 'verificationCode') {
        ...
        switchGreen.value = verificationCodeResponseData.value.code === 1 ? true : false
    }
}, {
    deep: true
})
...
watch(phoneNumberResponseData, () => {
    if (props.name === 'phoneNumber') {
        ...
        switchGreen.value = phoneNumberResponseData.value.code === 1 ? true : false
    }
}, {
    deep: true
})
...
watch(inviteIdentifierResponseData, () => {
    if (props.name === 'inviteIdentifier') {
        ...
        switchGreen.value = inviteIdentifierResponseData.value.code === 1 ? true : false
    }
}, {
    deep: true
})
...
watch(questionResponseData, () => {
    if (props.name === 'answer') {
        ...
        switchGreen.value = questionResponseData.value.code === 1 ? true : false
    }
}, {
    deep: true
})
