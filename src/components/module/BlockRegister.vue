...
import { phoneNumberService, usernameService, userRegisterService, smsService, codeVerifyService, checkIdentifierService, createOrderService } from '@/apis/user'
...
const { count, username, password, repassword, phoneNumber, verificationCode, inviteIdentifier, question, answer } = registerFormData
            ...
            <div class="flex-column" id="payment-container">
                <div class="flex-column space-between" id="payment-tips">
                    ...
                    <ul style="font-size: 12px;" id="payment-announcement">
                        ...
                        <li>注册成功后，用户可自助生成邀请码，使用该邀请码邀请朋友注册为会员，将获得30元返现，使用次数无限制，系统统计后于每月初发放。</li>
                    </ul>
